...
dir.home <- getwd()
dir.home <- paste(dir.home, '/MONOCLE/', sep = '')
mat.data <- list.files(paste(dir.home, 'data/', 
                 'DEGS_with_Monocle_', sampleid, '/Matrix_in/', sep = ''), full.names = T)
dir.data <- paste(dir.home, 'data/', 'DEGS_with_Monocle_', sampleid, '/Monocle_out/', sep = '')
dir.out <- list.files(paste(dir.home, 'data/', "DEGS_with_Monocle_", sampleid, 
                            "/Monocle_out", sep = ''), pattern = 'withFCs_', full.names = T)

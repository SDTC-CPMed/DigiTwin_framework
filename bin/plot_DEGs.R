...
dir.home <- getwd()
dir.data <- paste(dir.home, 
                  '/MONOCLE/data/DEGS_with_Monocle_HA/Monocle_out/withFCs_timepointX_AllergenChallenged_vs_NonChallenged/',
                  sep = '')
dir.out.images <- paste(dir.home,
                        '/images/',
                        sep = '')
...
dir.home <- getwd()
dir.data <- paste(dir.home, 
                  '/DGE_data/RCA_out/matrices_withCellTypes/full_matrix/',
                  sep = '')
dir.out.images <- paste(dir.home,
                        '/images/',
                        sep = '')
...
pdf('celltype_ratios_over_groups.pdf')
newplot
dev.off()
setwd(dir.home)
